...
class Header(nn.Module):
    ...
    def __init__(self, use_bn=True, use_dropout=False, dropout_rate=0.1):
...
class PIXOR(nn.Module):
    ...
    def __init__(self, geom, use_bn=True, decode=False, use_dropout=False, dropout_rate=0.1):
        super(PIXOR, self).__init__()
        self.backbone = BackBone(Bottleneck, [3, 6, 6, 3], geom, use_bn)
        self.header = Header(use_bn, use_dropout, dropout_rate)
